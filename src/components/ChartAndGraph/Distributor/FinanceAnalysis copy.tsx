                ...
                <div className="panel h-full p-0 border-0 overflow-hidden">
                    <div className="p-6 bg-gradient-to-r from-[#4361ee] to-[#160f6b] min-h-[190px]">
                        ...
                        <div className="text-white flex justify-between items-center">
                            ...
                            <h5 className="ltr:ml-auto rtl:mr-auto text-2xl">
                                2550<span className="text-white-light">₹</span>
                            </h5>
                        </div>
                    </div>
                    <div className="-mt-12 px-8 grid grid-cols-2 gap-2">
                        <div className="bg-white rounded-md shadow px-4 py-2.5 dark:bg-[#060818]">
                            ...
                            <div className="btn w-full  py-1 text-base shadow-none border-0 bg-[#ebedf2] dark:bg-black text-[#515365] dark:text-[#bfc9d4]">3000₹</div>
                        </div>
                        <div className="bg-white rounded-md shadow px-4 py-2.5 dark:bg-[#060818]">
                            <span className="flex justify-between items-center mb-4 dark:text-white">
                                Expence
                            ...
                            <div className="btn w-full  py-1 text-base shadow-none border-0 bg-[#ebedf2] dark:bg-black text-[#515365] dark:text-[#bfc9d4]">450₹</div>
                        </div>
                    </div>
                    <div className="p-5">
                        <div className="mb-5">
                        ...
                        <div className="mb-5 space-y-1">
                            <div className="flex items-center justify-between">
                                <p className="text-[#515365] font-semibold">Banglaluru</p>
                                <p className="text-base">
                                    <span>$</span> <span className="font-semibold">1400₹</span>
                                </p>
                            </div>
                            <div className="flex items-center justify-between">
                                <p className="text-[#515365] font-semibold">Kochi</p>
                                <p className="text-base">
                                    <span>$</span> <span className="font-semibold ">700₹</span>
                                </p>
                            </div>
                        </div>
