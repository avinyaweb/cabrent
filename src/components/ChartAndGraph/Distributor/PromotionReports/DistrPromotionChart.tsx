                        ...
                        <div className="space-y-9">
                            <div className="flex items-center">
                                ...
                                <div className="flex-1">
                                    <div className="flex font-semibold text-white-dark mb-2">
                                        ...
                                        <p className="ltr:ml-auto rtl:mr-auto">10,546</p>
                                    </div>
                            ...
                            <div className="flex items-center">
                                ...
                                <div className="flex-1">
                                    <div className="flex font-semibold text-white-dark mb-2">
                                        <h6>Bonus Master</h6>
                                        <p className="ltr:ml-auto rtl:mr-auto">3215</p>
                                    </div>
                                    <div className="w-full rounded-full h-2 bg-dark-light dark:bg-[#1b2e4b] shadow">
                                        {/* Using a single color without gradient */}
                                        <div className="bg-[#ff0000] w-full h-full rounded-full" style={{ width: '10%' }}></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center">
                                ...
                                <div className="flex-1">
                                    <div className="flex font-semibold text-white-dark mb-2">
                                        <h6> Coupon Master</h6>
                                        <p className="ltr:ml-auto rtl:mr-auto">7846</p>
                                    </div>
                                    <div className="w-full rounded-full h-2 bg-dark-light dark:bg-[#1b2e4b] shadow">
                            ...
                            <div className="flex items-center">
                                ...
                                <div className="flex-1">
                                    <div className="flex font-semibold text-white-dark mb-2">
                                        ...
                                        <p className="ltr:ml-auto rtl:mr-auto">10,576</p>
                                    </div>
                                    <div className="w-full rounded-full h-2 bg-dark-light dark:bg-[#1b2e4b] shadow">
                                        <div className="bg-gradient-to-r from-[#f09819] to-[#ff5858] w-full h-full rounded-full" style={{ width: '15%' }}></div>
                                    </div>
...
export default DistrPromotionChart;
