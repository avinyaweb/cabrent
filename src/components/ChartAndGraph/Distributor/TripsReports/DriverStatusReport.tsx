        ...
        <>
            <div className="panel overflow-hidden">
                <div className="flex items-center justify-between">
                    <div>
                        <div className="text-lg font-bold">Driver Status</div>
                ...
                <div className="relative mt-10">
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-6 text-center">
                        <div>
                            <div className="text-primary">Active Drivers</div>
                            <div className="mt-2 font-semibold text-2xl">150</div>
                        </div>
                        <div>
                            <div className="text-primary">Inactive Drivers</div>
                            <div className="mt-2 font-semibold text-2xl">125</div>
                        </div>
                        <div>
                            <div className="text-primary">In drive</div>
