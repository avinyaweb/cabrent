...
const CancelledTripsChart = () => {
    ...
    const salesByCategory: any = {
        ...
        options: {
            ...
            labels: ['Cancelled By Driver', 'Cancelled By Customer'],
            states: {
                hover: {
                    filter: {
                        type: 'none',
            ...
            <div className="grid xl:grid-cols-3 gap-6 mb-6">
                <div className="panel h-full">
                    <div className="flex items-center mb-5 justify-between">
                        <h5 className="font-semibold text-lg dark:text-white-light">Total Cancelled Report</h5>
                ...
                <div className="panel h-full xl:col-span-2">
                    <div className="flex items-start justify-between mb-5">
                        <h5 className="font-semibold text-lg dark:text-white-light">Cancellation Statics</h5>
                    </div>

                    <div className="panel overflow-hidden">
                        <div className="flex items-center justify-between">
                            <div>
                                <div className="text-lg font-bold">Total Cancellation</div>
                        ...
                        <div className="relative mt-10">
                            <div className="grid grid-cols-2 md:grid-cols-3 gap-6 text-center">
                                <div>
                                    <div className="text-primary">Cancelled by Drivers</div>
                                    <div className="mt-2 font-semibold text-2xl">150</div>
                                </div>
                                <div>
                                    <div className="text-primary">Cancelled by Customer</div>
...
export default CancelledTripsChart;
