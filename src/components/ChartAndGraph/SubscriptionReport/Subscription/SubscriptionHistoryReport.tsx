        ...
        <>
            <div className="flex flex-col">
                ...
                {/* <div className="flex flex-row items-center gap-1">
                    ...
                    <h5 className=" text-sm text-green-500">Total Purchased ₹55,540</h5>
                </div> */}
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6 mb-6 text-white mt-4">
                <div className="panel bg-gradient-to-r from-cyan-500 to-cyan-400">
                    ...
                    <div className="flex items-center mt-5">
                        <div className="text-3xl font-bold ltr:mr-3 rtl:ml-3">644</div>
                ...
                <div className="panel bg-gradient-to-r from-violet-500 to-violet-400">
                    ...
                    <div className="flex items-center mt-5">
                        <div className="text-3xl font-bold ltr:mr-3 rtl:ml-3">455</div>
                        <div className="badge bg-white/30">Today Report</div>
                    </div>
                    <div className="flex items-center font-semibold mt-5">
                        <IconEye className="ltr:mr-2 rtl:ml-2 shrink-0" />
                ...
                <div className="panel bg-gradient-to-r from-blue-500 to-blue-400">
                    <div className="flex justify-between">
                        <div className="ltr:mr-1 rtl:ml-1 text-md font-semibold">Expired Subscription</div>
                        <div className="dropdown">
                            <Dropdown
                                offset={[0, 5]}
                                placement={`${isRtl ? 'bottom-start' : 'bottom-end'}`}
                    ...
                    <div className="flex items-center mt-5">
                        <div className="text-3xl font-bold ltr:mr-3 rtl:ml-3">189</div>
                        <div className="badge bg-white/30">Today Report</div>
                    </div>
                    <div className="flex items-center font-semibold mt-5">
                        <IconEye className="ltr:mr-2 rtl:ml-2 shrink-0" />
                ...
                <div className="panel bg-gradient-to-r from-fuchsia-500 to-fuchsia-400">
                    ...
                    <div className="flex items-center mt-5">
                        <div className="text-3xl font-bold ltr:mr-3 rtl:ml-3">55,540 ₹</div>
                        <div className="badge bg-white/30">Today Report</div>
                    </div>
                    <div className="flex items-center font-semibold mt-5">
                        <IconEye className="ltr:mr-2 rtl:ml-2 shrink-0" />
