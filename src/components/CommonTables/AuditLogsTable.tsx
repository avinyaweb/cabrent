...
const AuditLogsTable = () => {
    ...
    const handleSelectChange = (selectedOption: string) => {
        ...
        } else if (selectedOption === 'document_uploads') {
            setSearch('Document uploads');
        } else if (selectedOption === 'profile_updated') {
            setSearch('Profile updated');
        } else if (selectedOption === 'verification_updated') {
            setSearch('Verification updated');
        } else if (selectedOption === 'created_ticket') {
            setSearch('Created ticket');
        } else if (selectedOption === 'updated_ticket') {
            setSearch('Updated ticket');
        } else if (selectedOption === 'document_exported') {
            setSearch('Document exported');
        }
    };
                ...
                <div className="grid grid-cols-1 sm:flex justify-between gap-5">
                    ...
                    <div className="lg:w-1/4 sm:w-full mb-4 sm:mb-0">
                        <select id="ctnSelect1" className="form-select text-white-dark" onChange={(e) => handleSelectChange(e.target.value)} required>
                            ...
                            <option value="verification_updated">Verification updated</option>
                            <option value="created_ticket">Created ticket</option>
                            <option value="updated_ticket">Updated ticket</option>
                            <option value="document_exported">Document exported</option>
                        </select>
                    </div>
                </div>
