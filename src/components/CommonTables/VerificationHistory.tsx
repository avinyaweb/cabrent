...
const verificationHistoryData = [
    {
        ...
        verificationTime: '2024-01-01T09:40:05.000Z',
        isVerificationRequired: 'true',
        remarks: 'Hello World 1',
    },
    {
        id: '2',
        verificationType: 'MANUAL',
        verificationStatus: 'APPROVED',
        verificationTime: '2024-01-02T09:45:10.000Z',
        isVerificationRequired: 'false',
        remarks: 'Hello World 2',
    },
    {
        id: '3',
        verificationType: 'AUTO',
        verificationStatus: 'REJECTED',
        verificationTime: '2024-01-03T10:00:15.000Z',
        isVerificationRequired: 'true',
        remarks: 'Hello World 3',
    },
];
...
const VerificationHistory = () => {
    ...
    // All states.
    const [UpdatedHistoryData, setUpdatedHistoryData] = useState<any>(verificationHistoryData);
    ...
    const columns: DataTableColumn<any>[] = [
        ...
        //     ),
        // },
        { accessor: 'verificationType', title: 'Verification Type', sortable: true, hidden: hiddenColumns.includes('verificationType') },
        { accessor: 'verificationStatus', title: 'Verification Status', sortable: true, hidden: hiddenColumns.includes('verificationStatus') },
        { accessor: 'verificationTime', title: 'Verification Time', sortable: true, hidden: hiddenColumns.includes('verificationTime') },
        { accessor: 'isVerificationRequired', title: 'Is Verification Required', sortable: true, hidden: hiddenColumns.includes('isVerificationRequired') },
