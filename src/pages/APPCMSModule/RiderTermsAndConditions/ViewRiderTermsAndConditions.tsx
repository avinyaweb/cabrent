...
interface viewRiderTermsAndConditionsProps {
    details: {
        archiveName: string;
        archive: string;
    };
...
const ViewRiderTermsAndConditions = () => {
    const data =
    ...
    return (
        <>
            <ol className="flex text-gray-500 font-semibold dark:text-white-dark flex-wrap">
                ...
                <li
                    className={`before:w-1 before:h-1 before:rounded-full before:bg-primary before:inline-block before:relative before:-top-0.5 before:mx-4 sm:mb-0 whitespace-nowrap sm:whitespace-normal ${
                        currentPath === '/APPCMSModule/RiderTermsAndConditions/ViewRiderTermsAndConditions' ? 'text-blue-600' : ''
                    }`}
                >
...
export default ViewRiderTermsAndConditions;
