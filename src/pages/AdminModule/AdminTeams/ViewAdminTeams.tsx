...
export const staticAdminTeamData: AdminTeamsData[] = [
    ...
    },
    {
        ...
        fk_reportingManager: 'Sony',
        teamLead: 'Ragu',
        fk_serviceCity: 'Mangluru +5',
...
const ViewAdminTeams: React.FC<AdminTeamInterface> = ({ tabs }) => {
