...
const EditChannelPartnerAPI: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const specificData = staticChannelPartnerAPIData.find((data) => data.id === channelPartnerAPIId);
    ...
    const navItems = [
        ...
        {
            label: 'Edit Channel Partner API',
            to: '/AdminModule/ChannelPartnerAPI/EditChannelPartnerAPI',
            className: `before:w-1 before:h-1 before:rounded-full before:bg-primary before:inline-block before:relative before:-top-0.5 before:mx-4 sm:mb-0 whitespace-nowrap sm:whitespace-normal ${
                currentPath === `/AdminModule/ChannelPartnerAPI/EditChannelPartnerAPI/${channelPartnerAPIId}` ? 'text-blue-600' : ''
            }`,
        },
    ];
        ...
        <>
            ...
            <div className="panel mt-6">
                <form onSubmit={handleSubmit}>
                    <ChannelPartnerAPIModule details={formData} onInputChange={handleInputChange} showStatus={true} isEditPage={true} />
...
export default EditChannelPartnerAPI;
