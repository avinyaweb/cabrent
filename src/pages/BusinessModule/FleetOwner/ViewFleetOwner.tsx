...
export const staticFleetOwnerData = [
    {
        ...
        TravelAgencyCompanyType: 'NGO limited',
    ...
    },
    {
        ...
        TravelAgencyCompanyType: 'Propritership',
        TravelAgencyType: 'Owner',
        agencyID: 'Agency984',
        firstName: 'Jane',
        middleName: 'Ella',
    ...
    },
    {
        ...
        TravelAgencyCompanyType: 'Private Limited',
        ...
        ProfileStatus: 'Approved',
        bankName: 'ABC Bank',
        bankLabel: 'Not Approved',
        walletBalance: 'Not Approved',
...
const ViewFleetOwner = ({ tabs, userManagementPage = true }: any) => {
    ...
    const columns: DataTableColumn<FleetOwnerData>[] = [
        ...
        { accessor: 'TravelAgencyType', title: 'Travel Agency Owner Type', sortable: true, hidden: hiddenColumns.includes('TravelAgency') },
        { accessor: 'TravelAgencyCompanyType', title: 'Travel Agency Company Type', sortable: true, hidden: hiddenColumns.includes('TravelAgencyCompanyType') },
        ...
        { accessor: 'companyType', title: 'Distributor Company Type', sortable: true, hidden: hiddenColumns.includes('companyType') },
        ...
        { accessor: 'vehicleNumber', title: 'Primary Vehicle Number', sortable: true, hidden: hiddenColumns.includes('vehicleNumber') },
        { accessor: 'driverMobileNumber', title: 'Primary Driver Mobile Number', sortable: true, hidden: hiddenColumns.includes('driverMobileNumber') },
        { accessor: 'driverName', title: 'Primary Driver Name', sortable: true, hidden: hiddenColumns.includes('driverName') },
    ];
                ...
                <div className="grid grid-cols-1 sm:flex justify-between gap-5">
                    {!tabs && (
                        <div className="lg:w-1/4 sm:w-full mb-4 sm:mb-0">
                            <Link to="/BusinessModule/FleetOwner/CreateFleetOwner" className="btn btn-primary block w-full sm:inline-block text-center mt-0">
