...
const PendingServiceProvider: React.FC<{ tabs: boolean; userManagementPage?: boolean }> = ({ tabs, userManagementPage = true }) => {
    ...
    const navItems = [
        ...
        },
        {
            ...
            to: '/BusinessModule/ServiceProvider/PendingServiceProvider',
            className: `before:w-1 before:h-1 before:rounded-full before:bg-primary before:inline-block before:relative before:-top-0.5 before:mx-4 sm:mb-0 whitespace-nowrap sm:whitespace-normal ${
                currentPath === '/BusinessModule/ServiceProvider/PendingServiceProvider' ? 'text-blue-600' : ''
            }`,
        },
    ];
