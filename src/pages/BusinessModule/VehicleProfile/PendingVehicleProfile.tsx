...
const PendingVehicleProfile: React.FC<{ tabs: boolean; userManagementPage?: boolean }> = ({ tabs, userManagementPage = true }) => {
    ...
    const navItems = [
        ...
        },
        {
            ...
            to: '/BusinessModule/VehicleProfile/PendingVehicleProfile',
            className: `before:w-1 before:h-1 before:rounded-full before:bg-primary before:inline-block before:relative before:-top-0.5 before:mx-4 sm:mb-0 whitespace-nowrap sm:whitespace-normal ${
                currentPath === '/BusinessModule/VehicleProfile/PendingVehicleProfile' ? 'text-blue-600' : ''
            }`,
        },
    ];
...
export default PendingVehicleProfile;
