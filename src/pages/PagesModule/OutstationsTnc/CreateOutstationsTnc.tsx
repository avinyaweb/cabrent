...
interface createOutstationsTncProps {
    details: {
        archiveName: string;
        archive: string;
    };
...
const CreateOutstationsTnc: React.FC<createOutstationsTncProps> = () => {
    const data = '';
        ...
        <>
            ...
            <div className="panel mt-6 ">
                <div className="flex items-center relative py-4">
                    <h1 className="text-2xl p-2 font-bold">Create Outstation</h1>
                </div>
                <form>
...
export default CreateOutstationsTnc;
