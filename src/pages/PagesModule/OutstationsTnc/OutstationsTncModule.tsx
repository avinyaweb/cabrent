...
interface OutstationsTncModuleProps {
    details: {
        archiveName: string;
        archive: string;
    };
...
const OutstationsTncModule: React.FC<OutstationsTncModuleProps> = ({ details, onInputChange, showStatus, viewSpecific, create, data, isEdit }) => {
        ...
        <>
            {viewSpecific && (
                <div className="flex items-center relative py-4">
                    {viewSpecific && <h1 className="text-2xl p-2 font-bold">Outstation</h1>}
                    <div className="flex items-center  gap-5">
                        <Link to={'/PagesModule/OutstationsTnc/editOutstationsTnc'}>
...
export default OutstationsTncModule;
