...
interface editRentailsTnCProps {
    details: {
        archiveName: string;
        archive: string;
    };
    ...
    return (
        <>
            <ol className="flex text-gray-500 font-semibold dark:text-white-dark flex-wrap">
                ...
                >
                    <Link to={'/PagesModule/RentailsTnC/ViewRentailsTnC'}>Rentails Tnc</Link>
                </li>
                <li
                    className={`before:w-1 before:h-1 before:rounded-full before:bg-primary before:inline-block before:relative before:-top-0.5 before:mx-4 sm:mb-0 whitespace-nowrap sm:whitespace-normal ${
                        currentPath === '/viewOutstationsTnc/viewOutstationsTnc' ? 'text-blue-600' : ''
            ...
            <div className="panel mt-6 ">
                <form>
                    <RentailsTnCModule data={data} details={{ archiveName: 'SomeName', archive: 'SomeArchive' }} onInputChange={(e) => {}} isEdit={true} />
...
export default EditRentailsTnC;
