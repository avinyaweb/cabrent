...
const EditBonusHistory: React.FC = () => {
        ...
        <>
            ...
            <div className="panel mt-6">
                <form onSubmit={handleSubmit}>
                    <BonusHistoryModule details={formData} onInputChange={handleInputChange} showStatus={true} />
...
export default EditBonusHistory;
