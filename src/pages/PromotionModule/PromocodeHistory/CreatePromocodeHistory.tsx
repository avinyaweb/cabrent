...
const CreatePromocodeHistory: React.FC = () => {
    ...
    const navItems = [
        ...
        {
            label: 'Create Promocode History',
            to: '/promotionModule/promocodeHistory/createPromocodeHistory',
            className: `before:w-1 before:h-1 before:rounded-full before:bg-primary before:inline-block before:relative before:-top-0.5 before:mx-4 sm:mb-0 whitespace-nowrap sm:whitespace-normal ${currentPath === '/promotionModule/promocodeHistory/createPromocodeHistory' ? 'text-blue-600' : ''}`,
        },
    ];
        ...
        <>
            ...
            <div className="panel mt-6">
                <form onSubmit={handleSubmit}>
                    <PromocodeHistoryModule details={formData} onInputChange={handleInputChange} showStatus={false} />
...
export default CreatePromocodeHistory;
