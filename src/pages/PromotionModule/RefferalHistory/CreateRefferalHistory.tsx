...
const CreateRefferalHistory: React.FC = () => {
    ...
    const navItems = [
        ...
        {
            label: 'Create Refferal History',
            to: '/PromotionModule/RefferalHistory/CreateRefferalHistory',
            className: `before:w-1 before:h-1 before:rounded-full before:bg-primary before:inline-block before:relative before:-top-0.5 before:mx-4 sm:mb-0 whitespace-nowrap sm:whitespace-normal ${currentPath === '/PromotionModule/RefferalHistory/CreateRefferalHistory' ? 'text-blue-600' : ''}`,
        },
    ];
        ...
        <>
            ...
            <div className="panel mt-6">
                <form onSubmit={handleSubmit}>
                    <RefferalHistoryModule details={formData} onInputChange={handleInputChange} showStatus={false} />
...
export default CreateRefferalHistory;
