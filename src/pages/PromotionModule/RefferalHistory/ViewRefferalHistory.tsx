...
const ViewRefferalHistory = ({ tabs }: { tabs: boolean }) => {
                        ...
                        <button
                            ...
                            onClick={() => {
                                if (rowData && rowData.id) {
                                    const editUrl = `/PromotionModule/RefferalHistory/EditRefferalHistory/${rowData.id}`;
...
export default ViewRefferalHistory;
