...
import DriverDutyModuleReport from './DriverDutyReportModule';
...
const ViewSpecificDriverDutyReport: React.FC = () => {
    ...
    const { DriverDutyReportId } = useParams();
    ...
    const navItems = [
        ...
        {
            label: 'View Driver Duty Report',
            to: '/ReportsModule/DriverDutyReport/ViewSpecificDriverDutyReport',
            className: `before:w-1 before:h-1 before:rounded-full before:bg-primary before:inline-block before:relative before:-top-0.5 before:mx-4 sm:mb-0 whitespace-nowrap sm:whitespace-normal ${
                currentPath === `/ReportsModule/DriverDutyReport/ViewSpecificDriverDutyReport/${DriverDutyReportId}` ? 'text-blue-600' : ''
            }`,
        },
    ];
    ...
    return (
        <>
            ...
            <div className="panel mt-6">
                <form>
                    <DriverDutyModuleReport details={formData} onInputChange={handleInputChange} showStatus={true} />
