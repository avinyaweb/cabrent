...
import DriverPaymentsModule from './DriverPaymentsModule';
...
const ViewSpecificDriverDutyReport: React.FC = () => {
    // future code --->>>
    // const dispatch = useDispatch();
    // const navigate = useNavigate();

    const { DriverPaymentsId } = useParams();
    ...
    //     const specificData = StaticData.find((data) => data.id === DriverDutyReportId);
    ...
    const navItems = [
        ...
        {
            label: 'View Driver payment',
            to: '/ReportsModule/DriverPayments/ViewSpecificDriverPayments',
            className: `before:w-1 before:h-1 before:rounded-full before:bg-primary before:inline-block before:relative before:-top-0.5 before:mx-4 sm:mb-0 whitespace-nowrap sm:whitespace-normal ${
                currentPath === `/ReportsModule/DriverPayments/ViewSpecificDriverPayments/${DriverPaymentsId}` ? 'text-blue-600' : ''
            }`,
        },
    ];
    ...
    return (
        <>
            ...
            <div className="panel mt-6">
                <form>
                    <DriverPaymentsModule details={formData} onInputChange={handleInputChange} showStatus={true} />
...
export default ViewSpecificDriverDutyReport;
