...
const TotalCouponClaimed = ({ tabs }: { tabs: boolean }) => {
    ...
    const navItems = [
        ...
        {
            label: 'Total Coupon Claimed',
            to: '/PromotionModule/CouponHistory/TotalCouponClaimed',
            className: `before:w-1 before:h-1 before:rounded-full before:bg-primary before:inline-block before:relative before:-top-0.5 before:mx-4 sm:mb-0 whitespace-nowrap sm:whitespace-normal ${
                currentPath === '/PromotionModule/CouponHistory/TotalCouponClaimed' ? 'text-blue-600' : ''
            }`,
        },
    ];
...
export default TotalCouponClaimed;
