...
const staticPriorityData: PriorityData[] = [
    {
        id: '1',
        totalKmTraveled: '234km',
        driverId: 'Ashraf',
    },
    {
        id: '2',
        totalKmTraveled: '313km',
        driverId: 'Afshan',
    },
    {
        id: '3',
        totalKmTraveled: '533km',
        driverId: 'Mahendra',
    },
    // Add more dummy data as needed
];

const TotalKmsTraveled = () => {
    ...
    useEffect(() => {
        const filteredData = initialRecords.filter((item) => {
            const { id = '', totalKmTraveled = '', driverId = '' } = item || {};

            const searchString = search ? search.toLowerCase() : ''; // Ensure search is defined and convert to lowercase

            return id?.toLowerCase().includes(searchString) || totalKmTraveled?.toLowerCase().includes(searchString) || driverId?.toLowerCase().includes(searchString);
        });
    ...
    const columns: DataTableColumn<PriorityData>[] = [
        ...
        { accessor: 'totalKmTraveled', title: 'Total Km Traveled', sortable: true, hidden: hiddenColumns.includes('totalKmTraveled') },
    ...
    const navItems = [
        ...
        {
            label: 'Total Kms Traveled',
            to: '/UtilityModule/Priority/TotalKmsTraveled',
            className: `before:w-1 before:h-1 before:rounded-full before:bg-primary before:inline-block before:relative before:-top-0.5 before:mx-4 sm:mb-0 whitespace-nowrap sm:whitespace-normal ${
                currentPath === '/UtilityModule/Priority/TotalKmsTraveled' ? 'text-blue-600' : ''
            }`,
        },
    ];
...
export default TotalKmsTraveled;
