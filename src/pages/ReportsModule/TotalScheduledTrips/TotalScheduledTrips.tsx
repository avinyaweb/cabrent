...
import TotalSheduledTripChart from '@/components/ChartAndGraph/ReportsChartAndGraph/ScheduledTrips/TotalScheduledTripChart';
...
export default TotalScheduledTrips;
