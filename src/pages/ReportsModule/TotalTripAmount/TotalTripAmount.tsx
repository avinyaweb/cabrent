...
const staticPriorityData: PriorityData[] = [
    {
        id: '1',
        tripId: 'BLR002',
        travelAgency: 'Abad travel agency',
        totalAmount: '23123',
    },
    {
        id: '2',
        tripId: 'KRL002',
        travelAgency: 'Mahesh Privet Limited',
        totalAmount: '12123',
    },
    {
        id: '3',
        tripId: 'BLR005',
        travelAgency: 'Subash limited',
        totalAmount: '63123',
    },
...
const TotalTripAmount = () => {
    ...
    //         if (data?.travelAgencys) {
    //           const filteredData = data.travelAgencys.filter((item: PriorityData) => {
    ...
    //             const { data } = await getAllPriority();
    //             if (data?.travelAgencys) {
    //                 const newData = data.travelAgencys.map(({ _id: id, ...rest }) => ({
    //                     id,
    //                     ...rest,
    //                 }));
    ...
    useEffect(() => {
        const filteredData = initialRecords.filter((item) => {
            const { id = '', tripId = '', travelAgency = '', totalAmount = '' } = item || {};

            const searchString = search ? search.toLowerCase() : ''; // Ensure search is defined and convert to lowercase

            return (
                id?.toLowerCase().includes(searchString) ||
                tripId?.toLowerCase().includes(searchString) ||
    ...
    const columns: DataTableColumn<PriorityData>[] = [
        ...
        { accessor: 'tripId', title: 'Trip Id', sortable: true, hidden: hiddenColumns.includes('tripId') },
        { accessor: 'travelAgency', title: 'Travel Agency', sortable: true, hidden: hiddenColumns.includes('travelAgency') },
        { accessor: 'totalAmount', title: 'Total Amount', sortable: true, hidden: hiddenColumns.includes('totalAmount') },
    ];
    ...
    const navItems = [
        ...
        },
        {
            ...
            to: '/UtilityModule/Priority/TotalTripAmount',
            className: `before:w-1 before:h-1 before:rounded-full before:bg-primary before:inline-block before:relative before:-top-0.5 before:mx-4 sm:mb-0 whitespace-nowrap sm:whitespace-normal ${
                currentPath === '/UtilityModule/Priority/TotalTripAmount' ? 'text-blue-600' : ''
            }`,
        },
    ];
...
export default TotalTripAmount;
