...
import TripPaymentsModule from './TripPaymentsModule';
...
const ViewSpecificTripPayments: React.FC = () => {
    // future code -->>.
    // const dispatch = useDispatch();
    // const navigate = useNavigate();

    const { TripPaymentsId } = useParams();
    ...
    //     const specificData = StaticData.find((data) => data.id === TripPaymentsId);
    ...
    const navItems = [
        ...
        {
            label: 'Trip Payment',
            to: '/ReportsModule/TripPayments/ViewSpecificTripPayments',
            className: `before:w-1 before:h-1 before:rounded-full before:bg-primary before:inline-block before:relative before:-top-0.5 before:mx-4 sm:mb-0 whitespace-nowrap sm:whitespace-normal ${
                currentPath === '/ReportsModule/TripPayments/ViewTripPayments' ? 'text-blue-600' : ''
            }`,
        },
        {
            label: 'View Trip Payment',
            to: '',
            className: `before:w-1 before:h-1 before:rounded-full before:bg-primary before:inline-block before:relative before:-top-0.5 before:mx-4 sm:mb-0 whitespace-nowrap sm:whitespace-normal ${
                currentPath === `/ReportsModule/TripPayments/ViewSpecificTripPayments/${TripPaymentsId}` ? 'text-blue-600' : ''
            }`,
        },
    ];
    ...
    return (
        <>
            ...
            <div className="panel mt-6">
                <form>
                    <TripPaymentsModule details={formData} onInputChange={handleInputChange} showStatus={true} />
...
export default ViewSpecificTripPayments;
