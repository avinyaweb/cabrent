    ...
    return (
        <>
            <ol className="flex text-gray-500 font-semibold dark:text-white-dark flex-wrap">
                ...
                <li
                    className={`before:w-1 before:h-1 before:rounded-full before:bg-primary before:inline-block before:relative before:-top-0.5 before:mx-4 sm:mb-0 whitespace-nowrap sm:whitespace-normal ${
                        currentPath === '/SendNotificationsModule/Notification/ViewNotification' ? 'text-blue-600' : ''
                    }`}
                >
                    Notification
                </li>
            ...
            <div className="panel mt-6 ">
                <div>
                    <h1 className="text-2xl p-2 font-bold">Push Notification</h1>
                    <form>
            ...
            <div className="panel mt-6 ">
                <div className="mt-5">
                    <h1 className="text-2xl p-2 font-bold">SMS</h1>
                    <form>
                        <div className="grid grid-cols-1 mt-5 sm:flex justify-between gap-5">
                            <div className="lg:w-1/2">
                                <label htmlFor="archiveName" className="block mb-1">
            ...
            <div className="panel mt-6 ">
                <div className="mt-5">
                    <h1 className="text-2xl p-2 font-bold">Whatsapp</h1>
                    <form>
                        <div className="grid grid-cols-1 mt-5 sm:flex justify-between gap-5">
                            <div className="lg:w-1/2">
                                <label htmlFor="archiveName" className="block mb-1">
