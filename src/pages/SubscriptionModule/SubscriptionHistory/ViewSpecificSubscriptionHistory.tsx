...
const ViewSpecificSubscriptionHistory: React.FC = () => {
            ...
            <div className="panel mt-6">
                <Tab.Group selectedIndex={currentTabIndex} onChange={setCurrentTabIndex}>
                    ...
                    <Tab.Panels>
                        <Tab.Panel>
                            <div className="mt-5">
                                <SubscriptionHistoryModule details={formData} onInputChange={handleInputChange} showStatus={true} viewSpecific={true} />
                                ...
                                <div className="grid grid-cols-1 sm:flex justify-between gap-5 mt-3">
                                    <div className="lg:w-1/3 ">
                                        ...
                                        <input name="cgst" type="text" id="cgst" value="5%" className="form-input w-full" readOnly />
                                    </div>
                                    <div className="lg:w-1/3">
                                        <label htmlFor="sgst" className="block mb-1 text-md font-bold">
                                            SGST
                                        </label>
                                        <input name="sgst" type="text" id="sgst" placeholder="Enter SGST" value="4%" className="form-input w-full" readOnly />
                                    </div>
                                    <div className="lg:w-1/3">
                                        <label htmlFor="planAmount" className="block mb-1">
                                            Processing Fee
                                        </label>
                                        <input name="planAmount" type="text" id="planAmount" className="form-input w-full" value="300" readOnly />
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-1 sm:flex justify-between gap-5 mt-6">
                                    ...
                                    <div className="lg:w-1/3">
                                        ...
                                        <input name="pgCharges" type="text" id="pgCharges" className="form-input w-full" value="Yes" readOnly />
                                    </div>
                                    <div className="lg:w-1/3">
                                        <label htmlFor="totalAmount" className="block mb-1">
                                            Total Amount
                                        </label>
                                        <input name="totalAmount" type="text" id="totalAmount" placeholder="Enter Total Amount" className="form-input w-full" value="5.6" readOnly />
                                    </div>
                                </div>
...
export default ViewSpecificSubscriptionHistory;
