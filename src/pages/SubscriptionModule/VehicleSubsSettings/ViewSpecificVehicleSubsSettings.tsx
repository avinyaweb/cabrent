...
const ViewSpecificVehicleSubsSettings: React.FC = () => {
    const dispatch = useDispatch();
    const navigate = useNavigate();
    const viewSpecific = true;

    const { settingsId }: { settingsId?: any } = useParams();
    ...
    //         try {
    //             const response = await getCountryById(settingsId);
            ...
            <div className="panel mt-6">
                <Tab.Group>
                    <Tab.List className="mt-3 flex flex-wrap border-b border-white-light dark:border-[#191e3a]">
                        <Tab as={Fragment}>
                            {({ selected }) => (
                                ...
                                >
                                    <MdOutlineWorkspacePremium className="w-5 h-5 ltr:mr-2 rtl:ml-2" />
                                    <span className="text-md font-bold">Veicle Subscription</span>
                                </button>
                            )}
                        </Tab>
                        <Tab as={Fragment}>
                    ...
                    <Tab.Panels>
                        <Tab.Panel>
                            <div className="mt-5">
                                <VehicleSubsSettingsModule details={formData} onInputChange={handleInputChange} showStatus={false} viewSpecific={true} />
...
export default ViewSpecificVehicleSubsSettings;
