...
const ViewBookingAmtDistribution = () => {
    ...
    const handleSelectChange = (selectedOption: string) => {
        if (selectedOption === 'edit' && selectedRecords.length === 1) {
            const editUrl = `/TripModule/BookingAmtDistribution/EditBookingAmtDistribution/${selectedRecords[0].id}`;
            navigate(editUrl);
        }
    };
            ...
            <div className="panel mt-6">
                <div className="grid grid-cols-1 sm:flex justify-between gap-5">
                    <div className="lg:w-1/4 sm:w-full mb-4 sm:mb-0">
                        <Link to="/TripModule/BookingAmtDistribution/CreateBookingAmtDistribution" className="btn btn-primary block w-full sm:inline-block text-center mt-0">
                            Create Booking Amt. Dist.
                        </Link>
                    </div>
