...
const EditBookings: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const specificData = staticBookingsData.find((data) => data.id === bookingsId);
        ...
        <>
            ...
            <div className="panel mt-6">
                <form onSubmit={handleSubmit}>
                    <BookingsModule details={formData} onInputChange={handleInputChange} showStatus={true} />
