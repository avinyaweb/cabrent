...
import { staticBookingsData } from './ViewBookings';
...
const ViewSpecificBookings: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const specificData: any = staticBookingsData.find((data) => data.id === bookingsId);
            ...
            <div className="panel mt-6">
                <Tab.Group>
                        ...
                        <Tab as={Fragment}>
                            {({ selected }) => (
                                ...
                                >
                                    ...
                                    <span className="text-md font-bold">Booking</span> */}
                                </button>
                            )}
                        </Tab>
                        {/* <Tab as={Fragment}>
                    ...
                    <Tab.Panels>
                        <Tab.Panel>
                            <div className="mt-5">
                                <BookingsModule details={formData} onInputChange={handleInputChange} showStatus={true} viewSpecific={viewSpecific} />
...
export default ViewSpecificBookings;
