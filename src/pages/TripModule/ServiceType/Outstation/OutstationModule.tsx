...
interface OutstationModuleProps {
    details: {
        packageName: string;
...
const OutstationModule: React.FC<OutstationModuleProps> = ({ details, onInputChange, showStatus = true, viewSpecific, isEditPage }) => {
...
export default OutstationModule;
