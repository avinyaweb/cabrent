...
// Define static data
export const staticOutstationData: AdminTeamsData[] = [
    {
        id: '1',
        packageName: '10Hrs',
...
const ViewOutstation = () => {
    ...
    const [adminTeamsData, setAdminTeamsData] = useState<AdminTeamsData[]>(staticOutstationData);
                ...
                <div className="flex items-center">
                        ...
                        <button
                            ...
                            onClick={() => {
                                if (rowData && rowData.id) {
                                    const editUrl = `/TripModule/ServiceType/Rental/EditOutstation/${rowData.id}`;
                    ...
                    <Tippy content="View Specific">
                        <button
                            ...
                            onClick={() => {
                                if (rowData && rowData.id) {
                                    const viewUrl = `/TripModule/ServiceType/Outstation/ViewSpecificOutstation/${rowData.id}`;
                                    navigate(viewUrl);
                                }
                            }}
                        >
    ...
    const navItems = [
        ...
        },
        {
            ...
            className: `before:w-1 before:h-1 before:rounded-full before:bg-primary before:inline-block before:relative before:-top-0.5 before:mx-4 sm:mb-0 whitespace-nowrap sm:whitespace-normal ${
                currentPath === '/UtilityModule/Country/ViewOutstation' ? 'text-blue-600' : ''
            }`,
        },
    ];
            ...
            <div className="panel mt-6">
                <div className="grid grid-cols-1 sm:flex justify-between gap-5">
                    <div className="lg:w-1/4 sm:w-full mb-4 sm:mb-0">
                        <Link to="/TripModule/ServiceType/Rental/CreatOutstation" className="btn btn-primary block w-full sm:inline-block text-center mt-0">
                            Create Outstation Package
                        </Link>
                    </div>
