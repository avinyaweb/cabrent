...
import { staticOutstationData } from './ViewOutstation';
...
const ViewSpecificOutstation: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const specificData: any = staticOutstationData.find((data) => data.id === OutstationID);
    ...
    //         try {
    //             const response = await getCountryById(OutstationID);
    ...
    const navItems = [
        ...
        {
            label: 'View Outstation',
            to: '/TripModule/ServiceType/Outstation/ViewSpecificOutstation',
            className: `before:w-1 before:h-1 before:rounded-full before:bg-primary before:inline-block before:relative before:-top-0.5 before:mx-4 sm:mb-0 whitespace-nowrap sm:whitespace-normal ${
                currentPath === `/TripModule/ServiceType/Outstation/ViewSpecificOutstation/${OutstationID}` ? 'text-blue-600' : ''
            }`,
        },
    ];
            ...
            <div className="panel mt-6">
                <Tab.Group>
                        ...
                        <Tab as={Fragment}>
                            {({ selected }) => (
                                ...
                                >
                                    ...
                                    <span className="text-md font-bold">Outstation Pakcage</span>
                                </button>
                            )}
                        </Tab>
                        <Tab as={Fragment}>
                    ...
                    <Tab.Panels>
                        <Tab.Panel>
                            <div className="mt-5">
                                <OutstationModule details={countryDetails} onInputChange={handleInputChange} showStatus={true} viewSpecific={viewSpecific} isEditPage={false} />
...
export default ViewSpecificOutstation;
