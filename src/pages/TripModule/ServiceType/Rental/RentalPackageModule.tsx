...
interface RentalPackageModuleProps {
    details: {
        packageName: string;
...
const RentalPackageModule: React.FC<RentalPackageModuleProps> = ({ details, onInputChange, showStatus = true, viewSpecific, isEditPage }) => {
...
export default RentalPackageModule;
