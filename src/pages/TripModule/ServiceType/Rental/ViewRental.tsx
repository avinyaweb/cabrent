...
// Define static data
export const staticRentalData: AdminTeamsData[] = [
    {
        id: '1',
        packageName: '10Hrs',
        packageDistunce: '50km',
        packageDuration: '10',
        fk_serviceCity: 'Bangalore',
    },
    {
        id: '2',
        packageName: '8Hrs',
        packageDistunce: '45km',
        packageDuration: '10',
...
const ViewRental = () => {
    ...
    const [adminTeamsData, setAdminTeamsData] = useState<AdminTeamsData[]>(staticRentalData);
    ...
    useEffect(() => {
        const filteredData = initialRecords.filter((item) => {
            const { id = '', packageName = '', packageDistunce = '', packageDuration = '', fk_serviceCity = '' } = item || {};

            const searchString = search ? search.toLowerCase() : ''; // Ensure search is defined and convert to lowercase

            return (
                id.toLowerCase().includes(searchString) ||
                packageName.toLowerCase().includes(searchString) ||
                packageDistunce.toLowerCase().includes(searchString) ||
                packageDuration.toLowerCase().includes(searchString) ||
    ...
    const columns: DataTableColumn<AdminTeamsData>[] = [
                ...
                <div className="flex items-center">
                        ...
                        <button
                            ...
                            onClick={() => {
                                if (rowData && rowData.id) {
                                    const editUrl = `/TripModule/ServiceType/Rental/EditRentalPackage/${rowData.id}`;
                    ...
                    <Tippy content="View Specific">
                        <button
                            ...
                            onClick={() => {
                                if (rowData && rowData.id) {
                                    const viewUrl = `/TripModule/ServiceType/Rental/ViewSpecificRental/${rowData.id}`;
                                    navigate(viewUrl);
                                }
                            }}
                        >
        ...
        { accessor: 'packageName', title: 'packageName', sortable: true, hidden: hiddenColumns.includes('packageName') },
        { accessor: 'packageDistunce', title: 'packageDistunce', sortable: true, hidden: hiddenColumns.includes('packageDistunce') },
        { accessor: 'packageDuration', title: 'packageDuration', sortable: true, hidden: hiddenColumns.includes('packageDuration') },
        { accessor: 'fk_serviceCity', title: 'fk_serviceCity', sortable: true, hidden: hiddenColumns.includes('fk_serviceCity') },
    ];
    ...
    const navItems = [
        ...
        },
        {
            ...
            className: `before:w-1 before:h-1 before:rounded-full before:bg-primary before:inline-block before:relative before:-top-0.5 before:mx-4 sm:mb-0 whitespace-nowrap sm:whitespace-normal ${
                currentPath === '/UtilityModule/Country/ViewRental' ? 'text-blue-600' : ''
            }`,
        },
    ];
            ...
            <div className="panel mt-6">
                <div className="grid grid-cols-1 sm:flex justify-between gap-5">
                    <div className="lg:w-1/4 sm:w-full mb-4 sm:mb-0">
                        <Link to="/TripModule/ServiceType/Rental/CreatRentalPackage" className="btn btn-primary block w-full sm:inline-block text-center mt-0">
