...
const CreateTickets: React.FC = () => {
    ...
    const navItems = [
        ...
        },
        {
            ...
            to: '/TripModule/Tickets/CreateTickets',
            className: `before:w-1 before:h-1 before:rounded-full before:bg-primary before:inline-block before:relative before:-top-0.5 before:mx-4 sm:mb-0 whitespace-nowrap sm:whitespace-normal ${currentPath === '/TripModule/Tickets/CreateTickets' ? 'text-blue-600' : ''}`,
        },
    ];
        ...
        <>
            ...
            <div className="panel mt-6">
                <form onSubmit={handleSubmit}>
                    <TicketsModule details={formData} onInputChange={handleInputChange} showStatus={false} />
