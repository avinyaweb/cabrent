...
interface StateData {
    id: string;
    Language: string;
    driverCanReason: string;
    riderCanReason: string;
...
const staticData: StateData[] = [
    {
        id: '1',
        Language: 'lan1',
        driverCanReason: 'leave reason 1',
        riderCanReason: 'leave reason 1',
        appResLanCode: '929392',
    },
    {
        id: '2',
        Language: 'lan2',
        driverCanReason: 'leave reason 2',
        riderCanReason: 'leave reason 2',
        appResLanCode: '929392',
    },
    {
        id: '3',
        Language: 'lan3',
        driverCanReason: 'leave reason 3',
        riderCanReason: 'leave reason 3',
        appResLanCode: '929392',
    },
];

const ViewCancellationReason = () => {
    ...
    useEffect(() => {
        const filteredData = initialRecords.filter((item) => {
            const { id = '', Language = '', driverCanReason = '', riderCanReason = '', appResLanCode = '' } = item || {};
    ...
    const columns: DataTableColumn<StateData>[] = [
                ...
                <div className="flex items-center">
                        ...
                        <button
                            ...
                            onClick={() => {
                                if (rowData && rowData.id) {
                                    const editUrl = `/UtilityModule/CancellationReasons/EditCancellation/${rowData.id}`;
                    ...
                    <Tippy content="View Specific">
                        <button
                            ...
                            onClick={() => {
                                if (rowData && rowData.id) {
                                    const viewUrl = `/UtilityModule/CancellationReasons/ViewSpecificCancellation/${rowData.id}`;
                                    navigate(viewUrl);
                                }
                            }}
                        >
        ...
        { accessor: 'Language', title: 'Language', sortable: true, hidden: hiddenColumns.includes('Language') },
        { accessor: 'driverCanReason', title: 'Driver Can Reason', sortable: true, hidden: hiddenColumns.includes('driverCanReason') },
        { accessor: 'riderCanReason', title: 'Rider Can Reason', sortable: true, hidden: hiddenColumns.includes('riderCanReason') },
    ];
            ...
            <div className="panel mt-6">
                <div className="grid grid-cols-1 sm:flex justify-between gap-5">
                    <div className="lg:w-1/4 sm:w-full mb-4 sm:mb-0">
                        <Link to="/UtilityModule/CancellationReasons/CreateCancellationReason" className="btn btn-primary block w-full sm:inline-block text-center mt-0">
                            Create Reason
                        </Link>
                    </div>
...
export default ViewCancellationReason;
