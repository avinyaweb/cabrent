...
import FeedBackReasonModule from '@/pages/UtilityModule/FeedbackReasons/FeedBackReasonModule';
...
const ViewSpecificFeedBackReason: React.FC = () => {
    ...
    const navItems = [
        ...
        {
            label: 'View Specific Feedback reason',
            to: '/UtilityModule/FeedbackReasons/ViewSpecificFeedbackReason',
            className: `before:w-1 before:h-1 before:rounded-full before:bg-primary before:inline-block before:relative before:-top-0.5 before:mx-4 sm:mb-0 whitespace-nowrap sm:whitespace-normal ${
                currentPath === '/UtilityModule/FeedbackReasons/ViewSpecificFeedbackReason' ? 'text-blue-600' : ''
            }`,
        },
    ];
            ...
            <div className="panel mt-6">
                <Tab.Group>
                    <Tab.List className="mt-3 flex flex-wrap border-b border-white-light dark:border-[#191e3a]">
                        <Tab as={Fragment}>
                            {({ selected }) => (
                                ...
                                >
                                    <MdOutlineFeedback className="w-5 h-5 ltr:mr-2 rtl:ml-2" />
                                    <span className="text-md font-bold">Feedback reason</span>
                                </button>
                            )}
                        </Tab>
                        <Tab as={Fragment}>
                    ...
                    <Tab.Panels>
                        <Tab.Panel>
                            <div className="mt-5">
                                <FeedBackReasonModule details={formData} onInputChange={handleInputChange} showStatus={false} viewSpecific={viewSpecific} />
...
export default ViewSpecificFeedBackReason;
