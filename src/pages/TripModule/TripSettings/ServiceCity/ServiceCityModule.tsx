            ...
            <div className="grid grid-cols-1 sm:flex justify-between gap-5 mt-6">
                <div className="lg:w-1/3">
                    ...
                    {viewSpecific ? (
                        ...
                        <input
                            ...
                            placeholder="Enter Driver Prefix Code"
                            className={`form-input w-full ${viewSpecific ? 'pointer-events-none' : ''}`}
                            value={details.driverPrefixCode}
                            onChange={onInputChange}
                        />
                    )}
                </div>
                <div className="lg:w-1/3">
                    ...
                    <input
                        ...
                        type="text"
                        id="tripPrefixCode"
                        placeholder="Enter Trip Prefix Code"
                        className={`form-input w-full ${viewSpecific ? 'pointer-events-none' : ''}`}
                        readOnly={viewSpecific}
                        value="KABL321"
                        onChange={onInputChange}
                ...
                <div className="lg:w-1/3">
                    ...
                    {viewSpecific ? (
                        <input name="Archive" type="text" id="Archive" className={`form-input w-full pointer-events-none`} value={'Type 1'} />
                    ) : (
                        <select id="Archive" className="form-select text-white-dark" required>
