...
interface ServiceTypeModuleProps {
    details: {
        country: string;
        state: string;
        city: string;
...
const ServiceTypeModule: React.FC<ServiceTypeModuleProps> = ({ details, onInputChange, showStatus = true, viewSpecific, isEdit }) => {
    // future code -->>
...
export default ServiceTypeModule;
