...
const ViewSpecificServiceType: React.FC = () => {
    // future code -->>
    ...
    useEffect(() => {
        const specificData: any = staticServiceTypeData.find((data) => data.id === ServiceTypeId);
        if (specificData) {
    ...
    //         setCountryDetails(response.data.ServiceType);
    //       } catch (error: any) {
    ...
    const navItems = [
        ...
        },
        {
            ...
            to: '/UtilityModule/ServiceType/ViewSpecificServiceType',
            className: `before:w-1 before:h-1 before:rounded-full before:bg-primary before:inline-block before:relative before:-top-0.5 before:mx-4 sm:mb-0 whitespace-nowrap sm:whitespace-normal ${
                currentPath === `/UtilityModule/ServiceType/ViewSpecificServiceType/${ServiceTypeId}` ? 'text-blue-600' : ''
            }`,
        },
    ];
            ...
            <div className="panel mt-6">
                <Tab.Group>
                    ...
                    <Tab.Panels>
                        <Tab.Panel>
                            <div className="mt-5">
                                <ServiceTypeModule details={ServiceTypeDetails} onInputChange={handleInputChange} showStatus={true} viewSpecific={viewSpecific} isEdit={false} />
                                <div className="grid grid-cols-1 sm:flex justify-between gap-5 mt-6">
                                    ...
                                    <div className="lg:w-1/3">
                                        ...
                                        <input name="approvedBy" type="text" id="approvedBy" className=" form-input w-full pointer-events-none " readOnly={viewSpecific} value={'2024-01-01'} />
                                    </div>
                                    <div className="lg:w-1/3">
                                    ...
                                    <div className="lg:w-1/3">
                                        ...
                                        <input name="createdBy" type="text" id="createdBy" className=" form-input w-full pointer-events-none " readOnly={viewSpecific} value={'2024-01-01'} />
                                    </div>
                                </div>
                            </div>
                        </Tab.Panel>
...
export default ViewSpecificServiceType;
