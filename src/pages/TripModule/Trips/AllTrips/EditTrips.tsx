...
import EditBookingAmtDistribution from '../../BookingAmtDistribution/EditBookingAmtDistribution';
        ...
        <>
            ...
            <div className="panel mt-6">
                <form onSubmit={handleSubmit}>
                    <TripsModule details={formData} onInputChange={handleInputChange} showStatus={true} />
                    <EditBookings />
                    <EditBookingAmtDistribution />
