...
export const staticTripsData = [
    {
        ...
        driverAcceptLocation: 'New Delhi',
        ...
        bookingCancelledBy: '',
        cancellationReason: '',
        bookingConfirmedHistory: 'Confirmed by rider',
...
const ViewTrips = () => {
    ...
    useEffect(() => {
        const filteredData = initialRecords.filter((item) => {
            ...
            return (
                ...
                riderPhone.toLowerCase().includes(searchString) ||
                driverAcceptLocation.toLowerCase().includes(searchString) ||
                ...
                isriderTrackedDriver.toLowerCase().includes(searchString) ||
    ...
    const columns: DataTableColumn<TripsData>[] = [
        ...
        { accessor: 'riderId', title: 'rider ID', sortable: true, hidden: hiddenColumns.includes('riderId') },
        { accessor: 'riderPhone', title: 'rider Phone', sortable: true, hidden: hiddenColumns.includes('riderPhone') },
        { accessor: 'driverAcceptLocation', title: 'From Location', sortable: true, hidden: hiddenColumns.includes('driverAcceptLocation') },
        ...
        { accessor: 'isriderTrackedDriver', title: 'Is rider Tracked Driver', sortable: true, hidden: hiddenColumns.includes('isriderTrackedDriver') },
                ...
                <div className="grid grid-cols-1 sm:flex justify-between gap-5">
                    ...
                    <div className="lg:w-1/4 sm:w-full mb-4 sm:mb-0">
                        <select id="ctnSelect1" className="form-select text-white-dark" onChange={(e) => handleSelectChange(e.target.value)} required>
                            ...
                            <option value="edit">Export</option>
                        </select>
                    </div>
                </div>
