...
const ViewHailTrips = () => {
    ...
    const [HailTripsData, setHailTripsData] = useState<TripsData[]>(staticTripsData);
    ...
    useEffect(() => {
        ...
        // future code --->>>
        // const fetchHailTripsData = async () => {
        //     try {
        //         const { data } = await getHailTripsData();
        //         if (data?.HailTripss) {
        //             // pk-note: ask backend developer to change the accessor _id:id, remove the following later
        //             const newData = data.HailTripss.map(({ _id: id, ...rest }: { _id: string; [key: string]: any }) => ({
        //                 id,
        //                 ...rest,
        //             }));
        //             //setHailTripsData(newData);
        //             setHailTripsData(staticTripsData);
        //         }
        //     } catch (error: any) {
    ...
    useEffect(() => {
        if (HailTripsData.length > 0) {
            const sortedData = HailTripsData.slice().sort((a, b) => {
    ...
    }, [HailTripsData, sortStatus, pageSize]);
    ...
    const handleRowClick = (row: TripsData) => {
        ...
        navigate(`/AdminModule/HailTrips/ViewSpecificHailTrips/${row.id}`);
    };
            ...
            <div className="panel mt-6">
                ...
                <div className="datatables mt-6">
                    <DataTable
                        ...
                        columns={columns}
                        highlightOnHover
                        totalRecords={HailTripsData.length}
