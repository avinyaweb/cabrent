...
import { staticVehicleFareMasterData } from './ViewVehicleFareMaster';
...
const EditVehicleFareMaster: React.FC = () => {
    const { vehicleFareMasterId } = useParams();
    ...
    useEffect(() => {
        ...
        const specificData = staticVehicleFareMasterData.find((data) => data.id === vehicleFareMasterId);
    ...
    const navItems = [
        ...
        },
        {
            ...
            className: `before:w-1 before:h-1 before:rounded-full before:bg-primary before:inline-block before:relative before:-top-0.5 before:mx-4 sm:mb-0 whitespace-nowrap sm:whitespace-normal ${currentPath === '/TripModule/VehicleFareMaster/ViewVehicleFareMaster' ? 'text-blue-600' : ''}`,
        },
        {
            label: 'Edit Vehicle Fare Master',
            to: '',
        ...
        <>
            ...
            <div className="panel mt-6">
                <form onSubmit={handleSubmit}>
                    <VehicleFareMasterModule details={formData} onInputChange={handleInputChange} showStatus={true} />
...
export default EditVehicleFareMaster;
