...
const ViewSpecificVehicleFareMaster: React.FC = () => {
    ...
    useEffect(() => {
        // Find the specific data based on the vehicleFareMasterId
        const specificData = staticVehicleFareMasterData.find((data) => data.id === vehicleFareMasterId);
    ...
    const navItems = [
        ...
        {
            label: 'View Vehicle Fare Master',
            to: '',
            className: `before:w-1 before:h-1 before:rounded-full before:bg-primary before:inline-block before:relative before:-top-0.5 before:mx-4 sm:mb-0 whitespace-nowrap sm:whitespace-normal ${
            ...
            <div className="panel mt-6">
                <Tab.Group>
                        ...
                        <Tab as={Fragment}>
                            {({ selected }) => (
                                ...
                                >
                                    ...
                                    <span className="text-md font-bold">Vehicle Fare Master</span>
                                </button>
                            )}
                        </Tab>
                        <Tab as={Fragment}>
                    ...
                    <Tab.Panels>
                        <Tab.Panel>
                            <div className="mt-5">
                                <VehicleFareMasterModule details={formData} onInputChange={handleInputChange} showStatus={true} viewSpecific={viewSpecific} />
...
export default ViewSpecificVehicleFareMaster;
