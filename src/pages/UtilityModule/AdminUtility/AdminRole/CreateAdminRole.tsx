...
import { createAdminRole } from '@/services/UtilityServices/AdminRoleServices';
...
const CreateAdminRole: React.FC = () => {
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        try {
            const response = await createAdminRole(formData);
    ...
    const navItems = [
        ...
        },
        {
            ...
            to: '/UtilityModule/AdminRole/CreateAdminRole',
            className: `before:w-1 before:h-1 before:rounded-full before:bg-primary before:inline-block before:relative before:-top-0.5 before:mx-4 sm:mb-0 whitespace-nowrap sm:whitespace-normal ${
                currentPath === '/UtilityModule/AdminRole/CreateAdminRole' ? 'text-blue-600' : ''
            }`,
        },
    ];
        ...
        <>
            ...
            <div className="panel mt-6">
                <form onSubmit={handleSubmit}>
                    <AdminRoleModule details={formData} onInputChange={handleInputChange} showStatus={false} />
