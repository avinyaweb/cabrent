...
const ViewSpecificEmployeeLevel: React.FC = () => {
    ...
    const navItems = [
        ...
        {
            label: 'View Employee Level',
            to: '/UtilityModule/EmployeeLevel/ViewSpecificEmployeeLevel',
            className: `before:w-1 before:h-1 before:rounded-full before:bg-primary before:inline-block before:relative before:-top-0.5 before:mx-4 sm:mb-0 whitespace-nowrap sm:whitespace-normal ${
                currentPath === `/UtilityModule/EmployeeLevel/ViewSpecificEmployeeLevel/${employeeLevelId}` ? 'text-blue-600' : ''
            }`,
        },
    ];
            ...
            <div className="panel mt-6">
                <Tab.Group>
                    <Tab.List className="mt-3 flex flex-wrap border-b border-white-light dark:border-[#191e3a]">
                        <Tab as={Fragment}>
                            {({ selected }) => (
                                ...
                                >
                                    <IoMan className="w-5 h-5 ltr:mr-2 rtl:ml-2" />
                                    <span className="text-md font-bold">Employee Level</span>
                                </button>
                            )}
                        </Tab>
                        <Tab as={Fragment}>
                    ...
                    <Tab.Panels>
                        <Tab.Panel>
                            <div className="mt-5">
                                <EmployeeLevelModule details={employeeLevelDetails} onInputChange={handleInputChange} showStatus={true} viewSpecific={viewSpecific} />
                                ...
                                <div className="grid grid-cols-1 sm:flex justify-between gap-5 mt-6">
                                    <div className="lg:w-1/3">
                                        ...
                                        <input
                                            ...
                                            // value={employeeLevelDetails?.approvedAt}
                                        />
                                    </div>
                                    <div className="lg:w-1/3">
                                        ...
                                        <input
                                            ...
                                            className={`form-input w-full ${viewSpecific ? 'pointer-events-none' : ''}`}
                                            readOnly={viewSpecific}
                                            value={employeeLevelDetails?.approvedBy}
                                        />
                                    </div>
                                    <div className="lg:w-1/3">
                                        ...
                                        <input
                                            ...
                                            className={`form-input w-full ${viewSpecific ? 'pointer-events-none' : ''}`}
                                            readOnly={viewSpecific}
                                            value={employeeLevelDetails?.createdAt}
                                        />
                                    </div>
                                    <div className="lg:w-1/3">
                                        ...
                                        <input
                                            ...
                                            className={`form-input w-full ${viewSpecific ? 'pointer-events-none' : ''}`}
                                            readOnly={viewSpecific}
                                            value={employeeLevelDetails?.createdBy}
                                        />
                                    </div>
                                </div>
                            </div>
...
export default ViewSpecificEmployeeLevel;
