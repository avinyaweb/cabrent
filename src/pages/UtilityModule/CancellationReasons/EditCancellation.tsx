...
const CreateCancellationReason: React.FC = () => {
        ...
        <>
            ...
            <div className="panel mt-6">
                <form onSubmit={handleSubmit}>
                    <CancellationModule details={formData} onInputChange={handleInputChange} showStatus={false} />
...
export default CreateCancellationReason;
