...
// Define static data
const staticAdminTeamsData: AdminTeamsData[] = [
    {
        id: '1',
        countryName: 'India',
        currencyName: 'Rupees',
        countryCode: '+91', // Dummy data for countryCode
        currencyCode: 'INR', // Dummy data for currencyCode
        phoneCode: 'IN', // Dummy data for phoneCode
        archive: 'PENDING',
    },
    {
        id: '2',
        countryName: 'USA',
        currencyName: 'Dollar',
        countryCode: '+1', // Dummy data for countryCode
        currencyCode: 'USD', // Dummy data for currencyCode
        phoneCode: 'US', // Dummy data for phoneCode
        archive: 'APPROVED',
    },
    {
        id: '3',
        ...
        currencyName: 'Pound',
        countryCode: '+44', // Dummy data for countryCode
        currencyCode: 'GBP', // Dummy data for currencyCode
        phoneCode: 'UK', // Dummy data for phoneCode
        archive: 'PENDING',
    },
];
...
const ViewCountry = () => {
    ...
    const [adminTeamsData, setAdminTeamsData] = useState<AdminTeamsData[]>(staticAdminTeamsData);
    ...
    useEffect(() => {
        const filteredData = initialRecords.filter((item) => {
            const { id = '', countryName = '', currencyName = '', archive = '' } = item || {};
            ...
            return (
                ...
                currencyName?.toLowerCase().includes(searchString) ||
    ...
    const columns: DataTableColumn<AdminTeamsData>[] = [
                ...
                <div className="flex items-center">
                        ...
                        <button
                            ...
                            onClick={() => {
                                if (rowData && rowData.id) {
                                    const editUrl = `/UtilityModule/Country/EditCountry/${rowData.id}`;
                    ...
                    <Tippy content="View Specific">
                        <button
                            ...
                            onClick={() => {
                                if (rowData && rowData.id) {
                                    const viewUrl = `/UtilityModule/Country/ViewSpecificCountry/${rowData.id}`;
                                    navigate(viewUrl);
                                }
                            }}
                        >
        ...
        { accessor: 'countryName', title: 'Country Name', sortable: true, hidden: hiddenColumns.includes('countryName') },
        { accessor: 'currencyName', title: 'Currency Name', sortable: true, hidden: hiddenColumns.includes('currencyName') },
        { accessor: 'countryCode', title: 'Country Code', sortable: true, hidden: hiddenColumns.includes('countryCode') },
        { accessor: 'currencyCode', title: 'Currency Code', sortable: true, hidden: hiddenColumns.includes('currencyCode') },
        { accessor: 'phoneCode', title: 'Phone Code', sortable: true, hidden: hiddenColumns.includes('phoneCode') },
            ...
            <div className="panel mt-6">
                <div className="grid grid-cols-1 sm:flex justify-between gap-5">
                    <div className="lg:w-1/4 sm:w-full mb-4 sm:mb-0">
                        <Link to="/UtilityModule/Country/CreateCountry" className="btn btn-primary block w-full sm:inline-block text-center mt-0">
                            Create Country
                        </Link>
                    </div>
