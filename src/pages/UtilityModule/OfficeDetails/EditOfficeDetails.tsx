...
const EditOfficeDetails: React.FC = () => {
    ...
    const navItems = [
        ...
        },
        {
            ...
            to: '/UtilityModule/OfficeDetails/EditOfficeDetails/',
            className: `before:w-1 before:h-1 before:rounded-full before:bg-primary before:inline-block before:relative before:-top-0.5 before:mx-4 sm:mb-0 whitespace-nowrap sm:whitespace-normal ${
                currentPath === `/UtilityModule/OfficeDetails/EditOfficeDetails/${OfficeDetailsId}` ? 'text-blue-600' : ''
            }`,
        },
    ];
