...
const ViewSpecificCountry: React.FC = () => {
    ...
    const navItems = [
        ...
        },
        {
            ...
            to: '/UtilityModule/ServiceCity/ViewSpecificServiceCity',
            className: `before:w-1 before:h-1 before:rounded-full before:bg-primary before:inline-block before:relative before:-top-0.5 before:mx-4 sm:mb-0 whitespace-nowrap sm:whitespace-normal ${
                currentPath === `/UtilityModule/ServiceCity/ViewSpecificServiceCity/${serviceCityId}` ? 'text-blue-600' : ''
            }`,
        },
    ];
                                ...
                                <div className="grid grid-cols-1 sm:flex justify-between gap-5 mt-6">
                                    <div className="lg:w-1/3">
                                        ...
                                        <input
                                            ...
                                            value={serviceCityDetails.approvedAt}
                                        />
                                    </div>
                                    <div className="lg:w-1/3">
                                        ...
                                        <input
                                            ...
                                            className=" form-input w-full pointer-events-none "
                                            readOnly={viewSpecific}
                                            value={serviceCityDetails.approvedBy}
                                        />
                                    </div>
                                    <div className="lg:w-1/3">
                                        ...
                                        <input
                                            ...
                                            className=" form-input w-full pointer-events-none "
                                            readOnly={viewSpecific}
                                            value={serviceCityDetails.createdAt}
                                        />
                                    </div>
                                    <div className="lg:w-1/3">
                                        ...
                                        <input
                                            ...
                                            className=" form-input w-full pointer-events-none "
                                            readOnly={viewSpecific}
                                            value={serviceCityDetails.createdBy}
                                        />
                                    </div>
                                </div>
                            </div>
