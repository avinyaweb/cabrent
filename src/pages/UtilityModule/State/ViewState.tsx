...
const staticStateData: StateData[] = [
    {
        id: '1',
        fk_country: 'India', // Country name instead of number
    ...
    {
        id: '3',
        fk_country: 'USA', // Country name instead of number
...
const ViewState = (onInputChange: any) => {
    ...
    const [allStateData, setAllStateData] = useState<StateData[]>(staticStateData);
    ...
    useEffect(() => {
        const filteredData = initialRecords.filter((item) => {
            const { id = '', fk_country = '', stateName = '', archive = '' } = item || {};

            const searchString = search ? search.toLowerCase() : ''; // Ensure search is defined and convert to lowercase

            return (
                id?.toLowerCase().includes(searchString) ||
                fk_country?.toLowerCase().includes(searchString) ||
                stateName?.toLowerCase().includes(searchString) ||
    ...
    const columns: DataTableColumn<StateData>[] = [
                ...
                <div className="flex items-center">
                        ...
                        <button
                            ...
                            onClick={() => {
                                if (rowData && rowData.id) {
                                    const editUrl = `/UtilityModule/State/EditState/${rowData.id}`;
                    ...
                    <Tippy content="View Specific">
                        <button
                            ...
                            onClick={() => {
                                if (rowData && rowData.id) {
                                    const viewUrl = `/UtilityModule/State/ViewSpecificState/${rowData.id}`;
                                    navigate(viewUrl);
                                }
                            }}
                        >
        ...
        { accessor: 'fk_country', title: 'Country Name', sortable: true, hidden: hiddenColumns.includes('fk_country') },
        { accessor: 'stateName', title: 'State Name', sortable: true, hidden: hiddenColumns.includes('stateName') },
    ...
    // future code -->>
    // const [country, setCountry] = useState(allStateData?.fk_country);
            ...
            <div className="panel mt-6">
                <div className="grid grid-cols-1 sm:flex justify-between gap-5">
                    <div className="lg:w-1/4 sm:w-full mb-4 sm:mb-0">
                        <Link to="/UtilityModule/State/CreateState" className="btn btn-primary block w-full sm:inline-block text-center mt-0">
                            Create State
                        </Link>
                    </div>

                    <div className="lg:w-1/4 sm:w-full mb-4 sm:mb-0">
                        <select id="fk_country" className="form-select text-white-dark" required onChange={handleCountryChange}>
