...
const ViewTicketType = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('View Ticket Type'));
    }, [dispatch]);
                ...
                <div className="flex items-center">
                        ...
                        <button
                            ...
                            onClick={() => {
                                if (rowData && rowData.id) {
                                    const editUrl = `/UtilityModule/TicketType/EditTicketType/${rowData.id}`;
                    ...
                    <Tippy content="View Specific">
                        <button
                            ...
                            onClick={() => {
                                if (rowData && rowData.id) {
                                    const viewUrl = `/UtilityModule/TicketType/ViewSpecificTicketType/${rowData.id}`;
                                    navigate(viewUrl);
                                }
                            }}
                        >
            ...
            <div className="panel mt-6">
                <div className="grid grid-cols-1 sm:flex justify-between gap-5">
                    <div className="lg:w-1/4 sm:w-full mb-4 sm:mb-0">
                        <Link to="/UtilityModule/TicketType/CreateTicketType" className="btn btn-primary block w-full sm:inline-block text-center mt-0">
                            Create Ticket Type
                        </Link>
                    </div>
