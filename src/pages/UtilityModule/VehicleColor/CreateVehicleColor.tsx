...
// import { CreateVehicleColor } from '@/services/UtilityServices/TicketTypeService';
...
const CreateVehicleColor: React.FC = () => {
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        try {
            const response = await CreateVehicleColor(formData);
            // if (response?.message) {
    ...
    const navItems = [
        ...
        },
        {
            ...
            to: '/UtilityModule/VehicleColor/CreateVehicleColor',
            className: `before:w-1 before:h-1 before:rounded-full before:bg-primary before:inline-block before:relative before:-top-0.5 before:mx-4 sm:mb-0 whitespace-nowrap sm:whitespace-normal ${
                currentPath === '/UtilityModule/VehicleColor/CreateVehicleColor' ? 'text-blue-600' : ''
            }`,
        },
    ];
        ...
        <>
            ...
            <div className="panel mt-6">
                <form onSubmit={handleSubmit}>
                    <VehicleColorModule details={formData} onInputChange={handleInputChange} showStatus={false} />
