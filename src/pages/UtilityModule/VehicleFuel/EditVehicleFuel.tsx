...
const EditVehicleFuel: React.FC = () => {
    ...
    const [vehiclefuel, setvehiclefuel] = useState<FormValues>(initialFormValues);
    ...
    useEffect(() => {
        const fetchChannelPartnerDetails = async () => {
            try {
                ...
                setvehiclefuel(response.data.TicketType);
            } catch (error: any) {
    ...
    const handleInputChange = (e: ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
        ...
        setvehiclefuel({ ...vehiclefuel, [name]: value });
    };
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        try {
            await updateTicketType(ticketTypeId, vehiclefuel);
        ...
        <>
            ...
            <div className="panel mt-6">
                <form onSubmit={handleSubmit}>
                    {/* <TicketTypeModule details={vehiclefuel} onInputChange={handleInputChange} showStatus={true} /> */}
...
export default EditVehicleFuel;
