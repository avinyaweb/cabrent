...
import VehicleFuelModule from './VehicleFuelModule';
...
const ViewSpecificVehicleFuel: React.FC = () => {
    ...
    const navItems = [
        ...
        },
        {
            ...
            className: `before:w-1 before:h-1 before:rounded-full before:bg-primary before:inline-block before:relative before:-top-0.5 before:mx-4 sm:mb-0 whitespace-nowrap sm:whitespace-normal ${
                currentPath === '/UtilityModule/vehicle/Viewvehicle' ? 'text-blue-600' : ''
            }`,
        },
        {
            label: 'View Vehicle Fuel',
            to: '/UtilityModule/VehicleFuel/ViewVehicleFuel',
            className: `before:w-1 before:h-1 before:rounded-full before:bg-primary before:inline-block before:relative before:-top-0.5 before:mx-4 sm:mb-0 whitespace-nowrap sm:whitespace-normal ${
                currentPath === `/UtilityModule/VehicleFuel/ViewSpecificVehicleFuel/1` ? 'text-blue-600' : ''
            }`,
        },
    ];
                        ...
                        <Tab as={Fragment}>
                            {({ selected }) => (
                                ...
                                >
                                    ...
                                    <span className="text-md font-bold">Vehicle Fuel</span>
                                </button>
                            )}
                        </Tab>
                        <Tab as={Fragment}>
                    ...
                    <Tab.Panels>
                        <Tab.Panel>
                            <div className="mt-5">
                                ...
                                <VehicleFuelModule details={ticketTypeDetails} onInputChange={handleInputChange} showStatus={true} viewSpecific={true} />
...
export default ViewSpecificVehicleFuel;
