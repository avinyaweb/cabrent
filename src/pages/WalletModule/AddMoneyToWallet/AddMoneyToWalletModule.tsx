...
interface AddMoneyToWalletModuleProps {
    details: {
        id: string;
...
const AddMoneyToWalletModule: React.FC<AddMoneyToWalletModuleProps> = ({ details, onInputChange, showStatus = true, viewSpecific }) => {
...
export default AddMoneyToWalletModule;
