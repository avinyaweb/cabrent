...
import AddMoneyToWalletModule from './AddMoneyToWalletModule';
...
const ViewSpecificAddMoneyToWallet: React.FC = () => {
    ...
    const navItems = [
        ...
        {
            label: 'View AddMoney to Wallet',
            to: '/WalletModule/AddMoneyToWallet/ViewSpecificAddMoneyToWallet',
            className: `before:w-1 before:h-1 before:rounded-full before:bg-primary before:inline-block before:relative before:-top-0.5 before:mx-4 sm:mb-0 whitespace-nowrap sm:whitespace-normal ${
                currentPath === `/WalletModule/AddMoneyToWallet/ViewSpecificAddMoneyToWallet/1` ? 'text-blue-600' : ''
            }`,
        },
    ];
            ...
            <div className="panel mt-6">
                <Tab.Group>
                    ...
                    <Tab.Panels>
                        <Tab.Panel>
                            <div className="mt-5">
                                <AddMoneyToWalletModule details={AddMoneyTowallet} onInputChange={handleInputChange} showStatus={true} viewSpecific={viewSpecific} />
...
export default ViewSpecificAddMoneyToWallet;
