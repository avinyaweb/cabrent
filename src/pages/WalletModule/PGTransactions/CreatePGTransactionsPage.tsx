...
const CreatePGTransactionsPage: React.FC = () => {
    ...
    const navItems = [
        ...
        {
            label: 'Create PG Transactions',
            to: '/TransactionModule/PGTransactions/CreatePGTransactions',
            className: `before:w-1 before:h-1 before:rounded-full before:bg-primary before:inline-block before:relative before:-top-0.5 before:mx-4 sm:mb-0 whitespace-nowrap sm:whitespace-normal ${
                currentPath === '/TransactionModule/PGTransactions/CreatePGTransactions' ? 'text-blue-600' : ''
            }`,
        },
    ];
        ...
        <>
            ...
            <div className="panel mt-6">
                <form onSubmit={handleSubmit}>
                    <PGTransactionsModulePage details={formData} onInputChange={handleInputChange} showStatus={false} viewSpecific={false} viewSpecificEdit={false} />
...
export default CreatePGTransactionsPage;
