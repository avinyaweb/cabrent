...
const ViewTownerCoins = () => {
    ...
    useEffect(() => {
        const filteredData = initialRecords.filter((item) => {
            const { id = '', PriorityName = '', archive = '' } = item || {};

            const searchString = search ? search.toLowerCase() : ''; // Ensure search is defined and convert to lowercase

            return id?.toLowerCase().includes(searchString) || PriorityName?.toLowerCase().includes(searchString) || archive?.toLowerCase().includes(searchString);
        });
    ...
    const columns: DataTableColumn<PriorityData>[] = [
        ...
        { accessor: 'PriorityName', title: 'Priority Name', sortable: true, hidden: hiddenColumns.includes('PriorityName') },
        { accessor: 'archive', title: 'Priority(Archive)', sortable: true, hidden: hiddenColumns.includes('archive') },
    ];
...
export default ViewTownerCoins;
