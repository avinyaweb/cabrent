...
import { staticTripTransactionData } from './ViewTripTransaction';
...
const ViewSpecificTripTransaction = () => {
    ...
    useEffect(() => {
        const specificData: any = staticTripTransactionData.find((data) => data.id === tripsInvoiceId);
...
export default ViewSpecificTripTransaction;
